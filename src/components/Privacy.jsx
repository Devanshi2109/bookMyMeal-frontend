  ...
  return (
    <div className="h-screen overflow-scroll hide-scrollbar bg-slate-100">
      <header className="flex items-center p-4 text-white bg-blue-900 ">
        ...
        <h1 className="flex-grow font-bold text-center">Privacy Policy</h1>
      </header>
      <main className="container p-4 mx-auto">
        ...
        <p>
          ...
          out a form. The information collected may include your name, email
        ...
        <p>
          ...
          transactions, send periodic emails, improve our website, personalize
          your experience, and administer contests, promotions, surveys, or
          other site features.
        </p>
        <h2 className="mt-4 font-bold">Information Sharing</h2>
        <p>
          We do not sell, trade, or otherwise transfer your personally
          identifiable information to outside parties without your consent. This
        ...
        <h2 className="mt-4 font-bold">Security</h2>
        <p>
          We implement a variety of security measures to maintain the safety of
          your personal information when you place an order or enter, submit, or
          access your personal information.
        </p>
        <h2 className="mt-4 font-bold">Changes to This Privacy Policy</h2>
        <p>
